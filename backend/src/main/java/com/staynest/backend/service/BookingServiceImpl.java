...
import com.staynest.backend.entity.*;
...
import com.staynest.backend.repository.*;
import com.staynest.backend.strategy.PricingService;
...
public class BookingServiceImpl implements BookingService{
    ...
    public void capturePayment(Event event) {
        ...
        log.info("Capture Payment", event.getType());
